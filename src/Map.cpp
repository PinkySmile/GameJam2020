...
//		this->_entities.emplace_back(new Player({*this->_game.resources.screen, "assets/entities/test.json", *this}, 5, 25, 25, 32, 32, 100, *this->_game.state.settings.inputs[1]));
	}
